...
<body><table align="center" border="0" cellpadding="1" cellspacing="0">
  <tbody><tr class="ramka"> 
    <td class="ramka"> 
      <table class="b10" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
        <tbody><tr> 
          ...
          <td rowspan="2" valign="top"> 
            <table align="center" border="0" cellpadding="0" cellspacing="2" width="100%">
              <tbody><tr> 
                <td class="b10" colspan="3" height="25" valign="bottom"> 
                  <div align="center"><font color="#FF0000">[commerce-receipt:payee-name]</font></div>                </td>
              </tr>
              <tr> 
                <td class="n6" colspan="3" height="10" valign="top"> 
                  <div align="center">(наименование получателя платежа)</div>
                </td>
              </tr>
              <tr> 
                <td class="b10" valign="bottom"> 
                  <div align="center"><font color="#FF0000">[commerce-receipt:payee-inn]</font> </div>                </td>
                <td valign="bottom"> 
                  <div align="center">№</div>
                </td>
                <td class="b10" valign="bottom"> 
                  <div align="center"><font color="#FF0000">[commerce-receipt:payee-account]</font></div>                </td>
              </tr>
              <tr> 
                <td class="n6" valign="top"> 
                  <div align="center">(ИНН/КПП получателя платежа)</div>
                </td>
                <td class="n6" valign="top">&nbsp;</td>
                <td class="n6" valign="top"> 
                  <div align="center">(номер р/с получателя платежа)</div>
                </td>
              </tr>
              <tr> 
                <td class="b10" colspan="3" valign="bottom"> 
                  <div align="center"> <font color="#FF0000">[commerce-receipt:bank-name]</font> </div>                </td>
              </tr>
              <tr> 
                <td class="n6" colspan="3" valign="top"> 
                ...
                <td colspan="3" valign="bottom"> 
                  <table border="0" cellpadding="1" cellspacing="0" width="100%">
                    <tbody><tr> 
                      <td>БИК</td>
                      <td class="b10">
                        <div align="center"><font color="#FF0000">[commerce-receipt:payee-bik]</font></div>                      </td>
                      <td> 
                        <div align="center">№</div>
                      </td>
                      <td> 
                        <div class="b10" align="center"><font color="#FF0000">[commerce-receipt:payee-corr]</font></div>                      </td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
              ...
              <tr> 
                <td colspan="3"> 
                  <div align="left">Назначение платежа: <font color="#FF0000">Заказ №[commerce-receipt:order-number]</font> </div>
                </td>
              </tr>
              <tr valign="top"> 
                  ...
                  <div align="center"> 
                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                      <tbody><tr> 
                        ...
                        <td class="b10" valign="bottom"> 
                          <div align="center"> <b><font color="#FF0000">[commerce-receipt:amount-int]</font>&nbsp;</b></div>
                        </td>
                        <td> 
                          <div align="center"><b>&nbsp;</b>руб.<b>&nbsp;</b></div>
                        </td>
                        <td class="b10" valign="bottom"> 
                          <div align="center">[commerce-receipt:amount-dec]</div>
                        </td>
                        <td> 
          ...
          <td class="b10" rowspan="2" valign="bottom"> 
            <div align="center"></div>
          </td>
          <td rowspan="9"></td>
        </tr>
